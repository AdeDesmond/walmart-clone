  ...
  return (
    <div className="p-10 w-full flex flex-col lg:flex-row items-center lg:items-start justify-center space-x-4 mx-auto space-y-4 lg:space-y-0">
      <div className="flex space-x-4">
        ...
        <Skeleton className="hidden lg:inline lg:q-[400px] lg:h-[300px] rounded-md" />
      </div>
      <div className="w-[400px] h-[500px] sm:h-[700px] rounded-md space-y-2 border p-2 animate-pulse">
